...
def main():
    ...
    # Instructions for testing the model are provided in the "Readme.txt" file.
    ...
    path_0_1 = "results/real/1_5m_11s.png" # Focal plane image 0.1 m above ground
    path_0_4 = "results/real/1_10m_21s.png" # Focal plane image 0.4 m above ground
    path_1_5 = "results/real/1_14m_29s.png" # Focal plane image 1.5 m above ground
